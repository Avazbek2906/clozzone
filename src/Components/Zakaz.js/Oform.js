                ...
                <div className="zakaz_content__main">
                    {
                        cartList ? cartList.map(item => {
                            return <div className="zakaz_content__div">
                                ...
                                <svg onClick={() => { dispatch(removeCart(item.id)); dispatch(removeCart_button(item.id)); dispatch(decreament()) }} style={{ cursor: "pointer", marginLeft: "auto", display: "block", marginRight: "32px" }} width="20" height="20" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">

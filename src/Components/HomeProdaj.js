...
import Cloth1 from './Clothes/Cloth1';
import Cloth2 from './Clothes/Cloth2';
import Cloth3 from './Clothes/Cloth3';
    ...
    return (
        <>
            <div className="home_prodaj__section">
                                            ...
                                            <Slider {...settings} >
                                                {
                                                    item.images.map(item => {
                                                        console.log(item);
                                                        return <div><img src={item.img} alt="error img" className="collection_img" /></div>
                                                    })
                                                }
                                            </Slider>
                                        </div>
                                    ...
                                    <div className="collection_cloth_div">
                                        ...
                                        <div className="collection_content__body">
                                            ...
                                            <div className="collection_body__circles">
                                                ...
                                                <div className="collection_circle collection_circle2_2"><div></div></div>
                                                <div className="collection_circle collection_circle3"><div></div></div>
                                                <div className="collection_circle collection_circle4"><div></div></div>
                                            </div>
                                            <button className="collection_button">Добавить в корзину</button>
                                    ...
                                    <div className="collection_cloth_div">
                                            ...
                                            <Slider {...settings} >
                                                {
                                                    item.images.map(item => {
                                                        console.log(item);
                                                        return <img src={item.img} alt="error img" className="collection_img" style={{ width: "80%" }} />
                                                    })
                                                }
                                            </Slider>
                                        </div>
                                        <div className="collection_content__body">
                                            ...
                                            <div className="collection_body__circles">
                                                <div className="collection_circle collection_circle2_1"><div></div></div>
                                                <div className="collection_circle collection_circle2"><div></div></div>
                                                <div className="collection_circle collection_circle4_3"><div></div></div>
                                                <div className="collection_circle collection_circle4"><div></div></div>
                                            </div>
                                            <button className="collection_button">Добавить в корзину</button>
                                        </div>
                ...
                <div className="collection_button__div">
                    {
                        isMore ? "" : <button onClick={() => setMore(true)} className="collection_button home_prodaj__button">Eщё</button>
                    }
                </div>


                {
                    isMore ? <div className="collection_content__clothes">
                        <Cloth1 />
                        <Cloth2 />
                        <Cloth3 />
                        <Cloth1 />

        ...
        <>
                        ...
                        return <>
                            <div className="collection_cloth_div">
                                    ...
                                    <Slider {...settings} >
                                        {
                                            item.images.map(item => {
                                                return <div><Link to="/БАЗОВАЯ"><img src={item.img} alt="error img" className="collection_img" /></Link></div>
                                            })
                                        }
                                    </Slider>
                                </div>
                                <div className="collection_content__body">
                                    ...
                                    <button onClick={() => handleShow(true)} className="collection_button">Добавить в корзину</button>
                                </div>
                            </div>
                        </>
                    }
            ...
            <Modal show={modal1} onHide={handleClose} centered className="add_small__modal">
                <Modal.Body className="add_corzina__modal">
                    ...
                    <button onClick={() => setModal2(true)}>ПЕРЕЙТИ В КОРЗИНУ</button>
                    <button onClick={() => setModal1(false)} style={{ backgroundColor: "black" }}>ПРОДОЛЖИТЬ ПОКУПКИ</button>
                </Modal.Body>
            </Modal>
